# euru_claude_weekly_review.ps1  (v1.8)
# Headless Claude Code weekly learning review for EURU TOS.
...
$PromptMd  = Join-Path $Repo "09_AI_AUTOMATION\EURU_WEEKLY_LEARNING_PROMPT.md"
$LogDir    = Join-Path $Repo "09_AI_AUTOMATION\LOGS"
$Lock      = Join-Path $LogDir "euru_repo.lock"   # SHARED lock (daily + weekly)
$Stamp     = Get-Date -Format "yyyy-MM-dd_HHmm"
$Today     = Get-Date -Format "yyyy-MM-dd"
$LogFile   = Join-Path $LogDir "weekly_review_$Stamp.log"
$ReviewRel = "08_DADOS_E_JOURNAL/AI_REVIEWS/WEEKLY_REVIEW_$Today.md"
$ReviewDir = Join-Path $Repo "08_DADOS_E_JOURNAL\AI_REVIEWS"
$Review    = Join-Path $ReviewDir ("WEEKLY_REVIEW_" + $Today + ".md")
$CommitMsg = "Euru OS - $Today - claude weekly learning review"
...
Log "=== EURU Claude weekly review v1.8 started $Stamp ==="
